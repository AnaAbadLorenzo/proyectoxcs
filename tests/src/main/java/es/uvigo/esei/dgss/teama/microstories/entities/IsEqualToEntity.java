...
/**
 * An abstract {@link Matcher} that can be used to create new matchers that compare entities by
 * their attributes.
 *
...
public abstract class IsEqualToEntity<T> extends TypeSafeMatcher<T> {
  ...
  public void describeTo(final Description description) {
    if (this.describeTo != null) this.describeTo.accept(description);
  }

  /**
   * Adds a new description using the template:
   *
   * <p>{@code <expected class> entity with value '<expected>' for <attribute>}
   *
  ...
  /**
   * Adds as the description of this matcher the {@link Matcher#describeTo(Description)} method of
   * other matcher.
   *
  ...
  /**
   * Compares the expected and the actual value of an array attribute. The elements of the attribute
   * will be checked using a custom matcher. If the comparison fails, the description of the error
   * will be updated.
   *
   * @param attribute the name of the attribute compared.
   * @param getter the getter function of the attribute.
   * @param actual the actual entity being compared to the expected entity.
   * @param matcherFactory a function that creates a matcher for the expected array values.
   * @param <R> type of the value returned by the getter.
   * @return {@code true} if the value of the expected and actual attributes are equals and {@code
   *     false} otherwise. If the result is {@code false}, the current description will be updated.
   */
  ...
  /**
   * Compares the expected and the actual value of an iterable attribute. The elements of the
   * attribute will be checked using a custom matcher. If the comparison fails, the description of
   * the error will be updated.
   *
   * @param attribute the name of the attribute compared.
   * @param getter the getter function of the attribute.
   * @param actual the actual entity being compared to the expected entity.
   * @param matcherFactory a function that creates a matcher for the expected iterable values.
   * @param <R> type of the value returned by the getter.
   * @return {@code true} if the value of the expected and actual attributes are equals and {@code
   *     false} otherwise. If the result is {@code false}, the current description will be updated.
   */
  ...
  /**
   * Compares the expected and the actual value of an attribute. If the comparison fails, the
   * description of the error will be updated.
   *
   * @param attribute the name of the attribute compared.
   * @param getter the getter function of the attribute.
   * @param actual the actual entity being compared to the expected entity.
  ...
  /**
   * Compares the expected and the actual value of an array attribute. If the comparison fails, the
   * description of the error will be updated.
   *
   * @param attribute the name of the attribute compared.
   * @param getter the getter function of the attribute.
  ...
  protected <R> boolean checkArrayAttribute(
    ...
    if (expectedValue == null && actualValue == null) {
      ...
      this.addTemplatedDescription(
          attribute, expectedValue == null ? "null" : Arrays.toString(expectedValue));
      return false;
  ...
  /**
   * Compares the expected and the actual value of an int array attribute. If the comparison fails,
   * the description of the error will be updated.
   *
   * @param attribute the name of the attribute compared.
   * @param getter the getter function of the attribute.
   * @param actual the actual entity being compared to the expected entity.
  ...
  /**
   * Utility method that generates a {@link Matcher} that compares several entities.
   *
  ...
  protected static <T> Matcher<Iterable<? extends T>> containsEntityInAnyOrder(
    ...
    final Collection<Matcher<? super T>> entitiesMatchers =
        stream(entities).map(converter).collect(toList());
  ...
  protected static <T> Matcher<Iterable<? extends T>> containsEntityInAnyOrder(
    ...
    final Collection<Matcher<? super T>> entitiesMatchers =
        StreamSupport.stream(entities.spliterator(), false).map(converter).collect(toList());

    return containsInAnyOrder(entitiesMatchers);
  }

  /**
   * Utility method that generates a {@link Matcher} that compares several entities in the same
   * received order.
   *
   * @param converter A function to create a matcher for an entity.
   * @param entities The entities to be used as the expected values, in the order to be compared.
   * @param <T> The type of the entity.
   * @return A new {@link Matcher} that compares several entities in the same received order.
   */
  @SafeVarargs
